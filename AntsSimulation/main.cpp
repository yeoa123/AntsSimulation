...
*/
    ...
    Agents ants2 = Agents(10000, 0x00FFFFFF);
    Agents ants3 = Agents(10000, 0x00FFFFFF);
    ants1.initialize("random");
    ants2.initialize("random");
    ants3.initialize("random");
